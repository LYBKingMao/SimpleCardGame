...
import uk.ac.qub.eeecs.game.cardDemo.MainMenu;
...
private Activity activity;
    ...
    public MenuScreen(Game game) {
       ...
       // assetManager.loadAndAddBitmap("OptionsScreenIcon","img/menu_button.png");
       ...
       // mOptionsScreenButton=new PushButton(
                //spacingX*4.5f,spacingY*0.5f,spacingX,spacingY,"OptionsScreenIcon",this);
    }
    ...
    public void draw(ElapsedTime elapsedTime, IGraphics2D graphics2D) {
        ...
        //mOptionsScreenButton.draw(elapsedTime,graphics2D,null,null);
    }
}
