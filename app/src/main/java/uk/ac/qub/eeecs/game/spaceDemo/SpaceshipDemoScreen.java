...
public class SpaceshipDemoScreen extends GameScreen {
	...
	private String mAssetFile="coach-hello.mp3";
	...
	public SpaceshipDemoScreen(Game game) {
		...
		assetManager.loadAndAddBitmap("Asteroid3","img/Asteroid3.png");
		assetManager.loadAndAddBitmap("Asteroid4","img/Asteroid4.png");
		...
		assetManager.loadAndAddMusic("NotSame","music/NotSame.mp3");
		...
		try {
			...
			mMediaPlayer.setDataSource("music/coach-hello.mp3");
...
public boolean CheckCollision(){
		...
		if(CollisionDetector.isCollision(boundingBox1,boundingBox2)){
			isCollision=true;
		}
		return true;
}
