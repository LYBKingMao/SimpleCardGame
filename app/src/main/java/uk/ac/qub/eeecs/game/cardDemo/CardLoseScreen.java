...
public class CardLoseScreen extends GameScreen {
     ...
     */
    public CardLoseScreen(Game game) {
        super("CardLoseScreen", game);
        AssetStore assetManager = mGame.getAssetManager();
        assetManager.loadAndAddBitmap("Lose", "img/lose.png");
        ...
        Lose= new GameObject(LEVEL_WIDTH / 2.0f,
                LEVEL_HEIGHT / 2.0f, LEVEL_WIDTH, LEVEL_HEIGHT, getGame()
                .getAssetManager().getBitmap("Lose"), this);
        back=new PushButton(
    ...
    public void draw(ElapsedTime elapsedTime, IGraphics2D graphics2D) {
        ...
        Lose.draw(elapsedTime,graphics2D);
